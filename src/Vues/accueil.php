<div class="accueil">
    ...
    <p>Sur notre site de ticketing vous pouvez faire des demandes de dépanage pour des éventuels problème qui ont lieu dans les salles informatique.</p>
    ...
    if (!isset($_SESSION['user']))
    {
        ...
        <p>Si vous rencontrez un problème n\'hésitez pas à vous inscrire ou vous connecter afin de nous communiquer votre problème, voici tout de même une vidéo d\'explication :</p>
